...
public abstract class PlotPanel extends JPanel {
    ...
    // RJY moved yellow to end
    public final static Color[] COLORLIST = {Color.BLUE, Color.RED, Color.GREEN, Color.ORANGE, Color.PINK, Color.CYAN, Color.MAGENTA, Color.YELLOW};
    ...
    public Rectangle2D.Double getPlotRectangle() {
        return plotCanvas.getPlotRectangle();
    }
