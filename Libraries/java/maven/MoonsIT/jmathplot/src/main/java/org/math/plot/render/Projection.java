...
/*
                ...
                if (draw.canvas.base.baseCoords == null) {
                    logger.info("***** draw.canvas.base.baseCoords is null");
                }
                logger.info("***** len " + draw.canvas.base.baseCoords.length);
                if (draw.canvas.base.baseCoords[0] == null) {
                    logger.info("***** draw.canvas.base.baseCoords[0] is null");
                }
                logger.info("***** len " + draw.canvas.base.baseCoords[0].length);
                logger.info("***** 0 " + i + " " + draw.canvas.base.baseCoords[0][i]);
                logger.info("***** " + (i + 1) + " " + i + " " + draw.canvas.base.baseCoords[i + 1][i]);

                if (baseScreenCoords == null) {
                    logger.info("***** baseScreenCoords is null");
                }
                logger.info("***** 0 0 " + baseScreenCoords[0][0]);
                logger.info("***** " + (i + 1) + " 0 " + baseScreenCoords[i + 1][0]);
                */
                try{
