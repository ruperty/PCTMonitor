 ...
 * @author ReStart
 */
public class MotorCountReferenceNeuralFunction extends BaseMotorNeuralFunction {

    static final Logger logger = Logger.getLogger(MotorCountReferenceNeuralFunction.class.getName());
    private int reference = 0;


    public MotorCountReferenceNeuralFunction(List<Parameters> ps) throws Exception {
        super(ps);
