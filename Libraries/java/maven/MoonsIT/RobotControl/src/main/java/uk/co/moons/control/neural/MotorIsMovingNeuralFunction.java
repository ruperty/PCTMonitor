 ...
 * @author ReStart
 */
public class MotorIsMovingNeuralFunction extends BaseMotorNeuralFunction {
    private static final Logger logger = Logger.getLogger(MotorIsMovingNeuralFunction.class.getName());

    private MotorHandler mh = null;
    
   
    public MotorIsMovingNeuralFunction(List<Parameters> ps) throws Exception {
        super(ps);
