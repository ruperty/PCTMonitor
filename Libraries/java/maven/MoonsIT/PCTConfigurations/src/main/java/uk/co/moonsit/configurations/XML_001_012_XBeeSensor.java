 ...
 * @author ReStart
 */
public class XML_001_012_XBeeSensor {
    ...
    public static void main(String[] args) throws Exception {
        String file = Utils.getFileName("Robot", "001-012-XBeeSensor.xml");

        XML_001_012_XBeeSensor xml = new XML_001_012_XBeeSensor();
        ...
        globals.put("XBee_Smoothness", "0.95");

        globals.put("XBeeSensorTimeChangeSmooth_Smoothness", "0.95");
    ...
    private Layer configureLayer0(String name) throws Exception {
        ...
        controllers.add(Generic.configureSensorXBee(false));
