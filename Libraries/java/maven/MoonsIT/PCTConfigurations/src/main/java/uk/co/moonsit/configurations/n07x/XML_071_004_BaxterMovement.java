 ...
 * @author ReStart
 */
public class XML_071_004_BaxterMovement {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String file = Utils.getFileName("Robot", "ROS", "071-004-BaxterMovement.xml");
        System.out.println(file);

        XML_071_004_BaxterMovement xml = new XML_071_004_BaxterMovement();
        ...
        globals.put(system + "ControlManualReference_Constant", "-0.1");
        system = "HandPitch";
    ...
    public XML_071_004_BaxterMovement() {
    }
    ...
    private void addArmControls(Layers layers, String side, int layerNum, int sidelayerNum) throws Exception {
        ...
        String[] movementSystems = new String[]{"ArmReach", "HandElevation", "HandPitch", "ShoulderYaw"};
        ...
        ControlFunction[] handReferences = addMovementControlSystems(layers, side, sidelayerNum, handSystemNames, movementSystems);
        if (getIndex("ShoulderYaw", movementSystems) >= 0) {
    ...
    private static ControlFunction getHandSystemReferenceWithConstantReferences(Layers layers, String side, int sidelayerNum, String movementSystem) throws Exception {
        ...
        ControlFunction velocityWeight = Utils.configureControlFunction(side + movementSystem + "MovementVelocityWeight", "...", "Constant", new String[][]{{"Constant", Globals.getInstance().get(side + movementSystem + "MovementVelocityWeight_Constant"), "Double"}}, null);
        ...
        return Modules.armHandMovementControls(layers, sidelayerNum, movementSystem, side, side + movementSystem + "ControlInput", velocityWeight, positionReference);
    }

    private static ControlFunction[] addMovementControlSystems(Layers layers, String side, int sidelayerNum, String[] handSystemNames, String[] movementSystems) throws Exception {
        ...
        i = 3;
        index = getIndex("ShoulderYaw", movementSystems);
        if (index == null) {
            handReferences[i] = getHandSystemManualReference(side, "ShoulderYawControl");
        } else {
            handReferences[i] = getHandSystemReferenceWithConstantReferences(layers, side, sidelayerNum, movementSystems[index]);
        }
    ...
    private static void addJointControlSystems(Controller controller, String side, String[] handSystems, String[] movementSystems) throws Exception {
        ...
        joint = "ShoulderYaw";//LeftShoulderYawMovementVelocityControlOutput side + joint + "MovementVelocityControlOutput"
    ...
    public void armGlobals(Globals globals, String side) throws Exception {
        ...
        globals.put(side + system + "ControlReference_Gain", "2000");
        globals.put(side + system + "ControlReference_Slow", "100000");
        ...
        globals.put(side + system + "ControlReference_Gain", "50000");
        ...
        globals.put(side + system + "ControlReference_Gain", "10000");
        globals.put(side + system + "ControlReference_Slow", "1000000");
        globals.put(side + system + "ControlReference_Initial", globals.get(system + "ControlManualReference_Constant"));
        globals.put(side + system + "ControlReference_Tolerance", "0.0001");
        ...
        system = "ShoulderYaw";
        globals.put(side + system + "ControlReference_Initial", globals.get(system + "ControlManualReference_Constant"));
        globals.put(side + system + "ControlReference_Gain", "15000");
        globals.put(side + system + "ControlReference_Slow", "1000000");

        system = "HandElevationMovement";
        globals.put(side + system + "PositionControlInput_Smooth", "0.9");
        globals.put(side + system + "PositionControlOutput_InScale", "3");
        globals.put(side + system + "PositionControlOutput_OutScale", "0.4");
        ...
        globals.put(side + system + "VelocityWeight_Constant", "1");
        globals.put(side + system + "VelocityControlReference_Weights", "1,1,1");

        system = "ArmReachMovement";
        globals.put(side + system + "PositionControlInput_Smooth", "0.9");
        globals.put(side + system + "PositionControlOutput_InScale", "2");
        globals.put(side + system + "PositionControlOutput_OutScale", "0.5");
        globals.put(side + system + "PositionControlReference_Constant", globals.get(system.substring(0, system.indexOf("Movement")) + "ControlManualReference_Constant"));
        globals.put(side + system + "VelocityWeight_Constant", "1");
        globals.put(side + system + "VelocityControlReference_Weights", "1,1,1");
