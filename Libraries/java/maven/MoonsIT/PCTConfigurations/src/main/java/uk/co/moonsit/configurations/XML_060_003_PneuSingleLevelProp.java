 ...
 * @author ReStart
 */
public class XML_060_003_PneuSingleLevelProp {
    ...
    public static void main(String[] args) throws Exception {
                String file = Utils.getFileName("Robot", "PneuControl", "060-003-PneuSingleLevelProp.xml");
        boolean test = true;

        XML_060_003_PneuSingleLevelProp xml = new XML_060_003_PneuSingleLevelProp();
        ...
        globals.put("PneuPositionControl_Gain", "0.1");
    ...
    public XML_060_003_PneuSingleLevelProp() {
