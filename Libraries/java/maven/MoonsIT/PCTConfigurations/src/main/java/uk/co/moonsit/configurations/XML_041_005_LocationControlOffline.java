 ...
 * @author ReStart
 */
public class XML_041_005_LocationControlOffline {
    ...
    public static void main(String[] args) throws Exception {
                String file = Utils.getFileName("Robot", "041-005-LocationControlOffline.xml");
        boolean test = true;
    ...
    public XML_041_005_LocationControlOffline() {
