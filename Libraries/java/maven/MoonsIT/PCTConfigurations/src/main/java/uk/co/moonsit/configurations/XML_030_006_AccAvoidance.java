 ...
 * @author ReStart
 */
public class XML_030_006_AccAvoidance {
    ...
    public static void main(String[] args) throws Exception {
                String file = Utils.getFileName("Robot", "030-006-AccAvoidance.xml");
        XML_030_006_AccAvoidance xml = new XML_030_006_AccAvoidance();
    ...
    public XML_030_006_AccAvoidance() {
