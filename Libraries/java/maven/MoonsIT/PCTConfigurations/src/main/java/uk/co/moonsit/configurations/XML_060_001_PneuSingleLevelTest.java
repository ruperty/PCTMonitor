 ...
 * @author ReStart
 */
public class XML_060_001_PneuSingleLevelTest {
    ...
    public static void main(String[] args) throws Exception {
                String file = Utils.getFileName("Robot", "PneuControl", "060-001-PneuSingleLevelTest.xml");
        boolean test = true;

        XML_060_001_PneuSingleLevelTest xml = new XML_060_001_PneuSingleLevelTest();
    ...
    public XML_060_001_PneuSingleLevelTest() {
